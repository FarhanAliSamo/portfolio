...
<!-- Mirrored from themes-park.net/product/html/reeni/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Jan 2025 07:32:13 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/favicon.svg">
    <title>About Reeni - Personal Portfolio</title>
    <!-- Bootstrap min css -->
