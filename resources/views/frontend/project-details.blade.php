...
<!-- Mirrored from themes-park.net/product/html/reeni/project-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Jan 2025 07:32:16 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/favicon.svg">
    <title>Project Details Reeni - Personal Portfolio</title>
    <!-- Bootstrap min css -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="header-content">
                        <div class="logo">
                            <a href="index.html">
                                <img class="logo-dark" src="assets/images/logo/white-logo-reeni-2.png" alt="logo">
                ...
                <div class="row g-5">
                    <div class="col-lg-5 col-md-6">
                        <div class="single-footer-wrapper border-right mr--20">
                            <div class="logo">
                                <a href="index.html">
                                    <img src="assets/images/logo/white-logo-reeni.png" alt="logo">
                                </a>
                            </div>
...
<!-- Mirrored from themes-park.net/product/html/reeni/project-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Jan 2025 07:32:17 GMT -->
</html>